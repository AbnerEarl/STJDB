...
public class Main29Activity extends AppCompatActivity {
        ...
        public void Func() {
            if (http.Result != null) {
                if (http.Result.equals("true")) {
                    Toast.makeText(Main29Activity.this, "添加成功" + http.Result, Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(Main29Activity.this, "添加失败"+http.Result, Toast.LENGTH_SHORT).show();
                }
            }
        }
    });
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        xuanzehaoyou=(TextView)this.findViewById(R.id.textView11);
        chazhao=(Button)this.findViewById(R.id.button23);
        fujinren=(Button)this.findViewById(R.id.button24);
        tianjia=(Button)this.findViewById(R.id.button25);
        sousuo=(EditText)this.findViewById(R.id.editText7);
        sousuo.requestFocus();
    ...
    //            values.put("frienduserid",friendid.trim());
                http1.Request("chazaofriend", values);
            }
        });
        ...
        tianjia.setOnClickListener(new Button.OnClickListener(){
            ...
            public void onClick(View v) {
                if (!flag){
                    Toast.makeText(Main29Activity.this,"请选择一个逗友", Toast.LENGTH_SHORT).show();
                    // return;
                }
                else if (flag){
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) {
               ...
               /* String st = "sdcard/";
                ...
                Toast.makeText(Main29Activity.this, "你已选择逗友：\n" + o.toString(), Toast.LENGTH_SHORT).show();
                flag = true;
    ...
    WebService http1=new WebService(new RequestFunc() {
        ...
        public void Func() {
                ...
                if (http1.Result!= null) {
                    ...
                    adapter =new ArrayAdapter(Main29Activity.this,android.R.layout.simple_list_item_1,ls);
                    listView.setAdapter(adapter);

                } else {
                    Toast.makeText(Main29Activity.this, "查找失败"+http1.Result, Toast.LENGTH_SHORT).show();
                }
        }
    });
